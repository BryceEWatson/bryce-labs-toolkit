...
REM lessons-extractor-reset.cmd
REM Safely clears lessons-extractor output artifacts.
REM
REM Usage:
REM   tools\lessons-extractor-reset.cmd [--dry-run] [--force] [--output <dir>]
REM
REM Options:
REM   --dry-run            Show what would be deleted without deleting anything
REM   --force              Skip confirmation prompt
REM   --output <dir>       Output directory (default: docs\ai\lessons-extractor)

set "SCRIPT_DIR=%~dp0"
set "REPO_ROOT=%SCRIPT_DIR%.."
set "OUTPUT_DIR=docs\ai\lessons-extractor"
set "DRY_RUN=false"
set "FORCE=false"
...
if not exist "!FULL_OUTPUT_DIR!" (
    echo lessons-extractor-reset: Output directory not found: !FULL_OUTPUT_DIR!
    echo   Nothing to clear.
    exit /b 0
)

REM Try preprocessor first
set "PREPROCESSOR=!REPO_ROOT!\skills\lessons-extractor\bin\lessons-preprocessor.cjs"
set "USE_NODE=false"
